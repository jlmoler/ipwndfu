...
arm64:
	aarch64-unknown-linux-gnu-gcc -nostdlib -o bin/usb_0xA1_2_arm64.o src/usb_0xA1_2_arm64.S
	aarch64-unknown-linux-gnu-objcopy -O binary -j .text bin/usb_0xA1_2_arm64.o bin/usb_0xA1_2_arm64.bin
	rm bin/usb_0xA1_2_arm64.o

	aarch64-unknown-linux-gnu-gcc -nostdlib -o bin/checkm8_arm64.o src/checkm8_arm64.S
	aarch64-unknown-linux-gnu-objcopy -O binary -j .text bin/checkm8_arm64.o bin/checkm8_arm64.bin
	rm bin/checkm8_arm64.o

	aarch64-unknown-linux-gnu-gcc -nostdlib -o bin/t8010_t8011_disable_wxn_arm64.o src/t8010_t8011_disable_wxn_arm64.S
	aarch64-unknown-linux-gnu-objcopy -O binary -j .text bin/t8010_t8011_disable_wxn_arm64.o bin/t8010_t8011_disable_wxn_arm64.bin
	rm bin/t8010_t8011_disable_wxn_arm64.o

	aarch64-unknown-linux-gnu-gcc -nostdlib -o bin/t8015_shellcode_arm64.o src/t8015_shellcode_arm64.S
	aarch64-unknown-linux-gnu-objcopy -O binary -j .text bin/t8015_shellcode_arm64.o bin/t8015_shellcode_arm64.bin
